    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
            ...
            else if(role.equals(Constants.DOCTOR))
            {
                ...
                queryString = "SELECT DISTINCT SO.VisitID, SO.OperationDateTime, SO.OperationName, S.FirstName, S.LastName, O.Name, O.Description, O.EstTime, V.PatientID, P.FirstName, P.LastName, D.FirstName, D.LastName "+
