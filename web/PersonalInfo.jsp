...
<html>
    <head>
        ...
        <% String buttons = "<button type = \"submit\" style=\"width:54px;height:35px;\" formaction=\"PersonalInfo?mode=2\">Edit</button>";%>
        <% String disabled = "";
           if(mode == 1)
           {
               disabled = "disabled";
           ...
           {
               buttons = "<button type = \"submit\" style=\"width:54px;height:35px;\" formaction=\"PersonalInfo?mode=1\" formnovalidate>Cancel</button>"
                       + "&nbsp&nbsp&nbsp"
